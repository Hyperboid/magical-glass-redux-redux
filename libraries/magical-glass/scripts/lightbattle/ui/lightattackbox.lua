...
function LightAttackBox:createBolts()
    ...
    for i,battler in ipairs(Utils.shuffle(self.attackers)) do
        ...
        lane.speed = lane.weapon and lane.weapon.getLightBoltSpeed and lane.weapon:getLightBoltSpeed() or 12 + (not Game.battle.multi_mode and Utils.random(0, 2, 1) or 0)
        lane.attacked = false
        lane.score = 0
        lane.stretch = nil
